...
<section class="section-1">
	...
	<div class="form-group">
		...
		<input type="number" class="form-control" id="mobileNo" placeholder="" name="mobileno"  onKeyPress="if(this.value.length==10) return false;">
	</div>
	<div class="form-group">
		<label for="">Address</label><br>
		<textarea rows="3" class="textarea_text" id="address" placeholder="" name="address" ></textarea>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="nearestcity" placeholder="" name="nearestcity" >
	</div>
	<div class="form-group">
		<label for="">About You </label><br>
		<textarea rows="3" class="textarea_text" id="about_u" placeholder="" name="about_u" ></textarea>
	</div>
...
<section class="section-2 d-none">
	<div class="form-group">
		...
		<textarea rows="3" class="textarea_text" id="practicing" placeholder="" name="practicing" ></textarea>
	</div>
	<div class="form-group">
		<label for="">Specialized practice areas</label><br>
		<textarea rows="3" class="textarea_text" id="practicearea" placeholder="" name="practicearea" ></textarea>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<textarea rows="3" class="textarea_text" id="noofleagalcases" placeholder="" name="noofleagalcases" ></textarea>
	</div>
	<div class="form-group">
		<label for="">Education </label><br>
		<textarea rows="3" class="textarea_text" id="education" placeholder="" name="education" ></textarea>
	</div>
	<div class="form-group">
		<label for="">Experience if any (optional)</label><br>
		<textarea rows="3" class="textarea_text" id="experience" placeholder="" name="experience" ></textarea>
	</div>
	<div class="form-group">
		<label for="">Consultation Fee</label><br>
		 <input type="text" class="form-control rupee" id="consultationfee" placeholder="" name="consultationfee">
	</div>
	<div class="form-group">
		<label for="">Cost Per Hour (optional)</label><br>
		 <input type="text" class="form-control rupee" id="cph" placeholder="" name="cph">
	</div>
	<p>         
...
<section class="section-3 d-none">
	...
	<div class="form-group custom-file">
		<label class="custom-file-label" for="resumeFile">Enrolment Certificate </label><br>
		<div>
